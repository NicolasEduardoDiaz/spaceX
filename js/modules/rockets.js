...
export const getAllRocketId = async (id) => {
...
export const getRocketSecondStageCompositeFairingDiameterTotal = async ()=> {
    ...
    let res = await fetch("https://api.spacexdata.com/v4/rockets/query", config);
    let {docs:[maxHeightConpositeFairingRocket ]} = await res.json();
    let {second_stage: {payloads: {composite_fairig: {height}}}} = maxHeightConpositeFairingRocket
    return height;
}
